...
import { StorageProvider, UploadedFileResult } from './storage/storage-provider.interface';
...
export class UploadsService {
  ...
  async uploadImage(file: Express.Multer.File | undefined, folder?: string): Promise<UploadedFileResult> {
